...
class GBM_Case(Enum):
    ...
    ClosedSolution = 2              # European call with closed solution as output
    ClosedSolutionAddtiveNoise = 3  # European call with closed solution plus additive noise as output
